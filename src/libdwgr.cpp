...
bool dwgR::getPreview()
{
    ...
    else
    {
        ...
        std::cout << "ERROR DRW::BAD_READ_METADATA";
    }
...
//testReader();return false;
    ...
    if (isOk)
    {
        ...
        else
        {
            ...
            std::cout << "ERROR DRW::BAD_READ_FILE_HEADER";
        }
    }
    else
    {
...
//        reader = new dwgReader09(&filestr, this);
    ...
    if (reader == NULL)
    {
        ...
        std::cout << "ERROR DRW::BAD_VERSION";
        filestr->close();
    }
    else
        isOk = true;
...
bool dwgR::processDwg()
{
    ...
    if (!ret)
    {
        ...
        std::cout << "ERROR DRW::BAD_READ_HEADER";
    }
    ...
    if (ret && !ret2)
    {
        ...
        std::cout << "ERROR DRW::BAD_READ_CLASSES";
        ret = ret2;
    }
    ...
    if (ret && !ret2)
    {
        ...
        std::cout << "ERROR DRW::BAD_READ_HANDLES";
        ret = ret2;
    }
    ...
    if (ret && !ret2)
    {
        ...
        std::cout << "ERROR DRW::BAD_READ_TABLES";
        ret = ret2;
    }
    ...
    if (ret && !ret2)
    {
        ...
        std::cout << "ERROR DRW::BAD_READ_BLOCKS";
        ret = ret2;
    }
    ...
    if (ret && !ret2)
    {
        ...
        std::cout << "ERROR DRW::BAD_READ_ENTITIES";
        ret = ret2;
    }
    ...
    if (ret && !ret2)
    {
        ...
        std::cout << "ERROR DRW::BAD_READ_OBJECTS";
        ret = ret2;
    }
